...
public interface TurnoRepository extends JpaRepository<Turno, Long>{
    ...
    List<Turno> findByMedicoAndFechaHoraBetweenOrderByFechaHora(Medico medico, LocalDateTime fechaInicio, LocalDateTime fechaFin);
    ...
    List<Turno> findTurnosDisponibles(@Param("medico") Medico medico, @Param("inicio") LocalDateTime inicio, @Param("fim") LocalDateTime fin, @Param("estadosExcluidos") List<EstadoTurno> estadosExcluidos);
